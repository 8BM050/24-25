...
description: "In this lecture, we will mainly discuss metabolic aspects of exercise."
...
-Describe the physiological aspects of exercise (different types), with focus on skeletal muscle (different types of exercise, different energy sources)
