...
listing:
  ...
  - id: lectures
    ...
    type: table
    categories: false
    fields: [date, time, title, location]
    sort: date
...
Due to the cyber attack at the Eindhoven University of Technology, the start of the course has been postponed by **one week**. The course will now start on February 12, 2025. The course schedule has been adjusted accordingly. Please check the schedule below for the new dates of the lectures.
:::
