---
title: "Welcome to 8BM050 Systems Biology Models"
engine: julia
toc: false
page-layout: full
execute:
...
function welcome(weeknumber::Int, page_1::String, page_1_link::String, page_2::String, page_2_link::String)
  return Markdown.parse("Welcome to **week $(weeknumber)** of the 8BM050 course!\n\nLecture A: [$(page_1)]($(page_1_link))\n\nLecture B: [$(page_2)]($(page_2_link))")
end

notification_dates = Dict(
  DateTime(2025, 2, 5) => welcome(
    1, "Course Introduction", "content/1a-course-introduction.qmd",
    "Graph Theory", "content/1b-graph-theory.qmd"),
  DateTime(2025, 2, 12) => welcome(
    2, "Dynamic Models", "content/2a-differential-equations.qmd",
    "Cell Biology of Metabolism", "content/2b-cell-biology.qmd"),
  DateTime(2025, 2, 19) => welcome(
    3, "Biological Models", "content/3a-biological-models.qmd",
    "Digestive System", "content/1b-digestive-system.qmd"),
  DateTime(2025, 2, 26) => welcome(
    4, "Building Models", "content/4a-building-models.qmd",
    "Organ Specialization", "content/4b-organ-specialization.qmd"),
  DateTime(2025, 3, 12) => welcome(
    5, "Communication Systems", "content/5a-communication-systems.qmd",
    "Metabolism in Daily Life", "content/5b-metabolism-in-daily-life.qmd"),
  DateTime(2025, 3, 19) => welcome(
    6, "Energy Balance", "content/6a-energy-balance.qmd",
    "Diabetes", "content/6b-energy-balance.qmd"),
  DateTime(2025, 3, 26) => welcome(
    7, "Endocrinology", "content/7a-endocrinology.qmd",
    "Case Studies in Clinical Endocrinology", "content/7b-clinical-endocrinology.qmd"),
)
...
if isnothing(notification_index)
  ...
  notification = notification_dates[sort(collect(keys(notification_dates)))[notification_index]]
end
...
## 📅 Lecture Schedule
Below you can find the scheduled lectures. You can also use the navigation bar on the left to navigate to various lecture pages.
