...
notification_dates = Dict(
  ...
  DateTime(2025, 3, 19) => welcome(
    6, "Immunometabolism", "lectures/6a-immunometabolism.qmd",
    "Diabetes", "lectures/6b-diabetes.qmd"),
  DateTime(2025, 3, 26) => welcome(
    7, "Endocrinology", "lectures/7a-endocrinology.qmd",
    "Case Studies in Clinical Endocrinology", "lectures/7b-clinical-endocrinology.qmd"),
)
